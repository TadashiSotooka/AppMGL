...
{
    public class AmigoRejeitadoApplication
    {
        public AmigoReturn RetornarAmigo(string codUsuario)
        {
            ...
            var uri = new Uri("http://tccmgl-com.umbler.net/webservices/mglservices/amigo/readByRejeitado.php?idUsuario=" + codUsuario);
