...
{
    public class ListaCompletadoApplication
    {
        public ListaReturn RetornarListaUsuario(string codUsuario)
        {
            ...
            var uri = new Uri("http://tccmgl-com.umbler.net/webservices/mglservices/lista/readCompletado.php?idUsuario=" + codUsuario);
